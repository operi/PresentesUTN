...
export class Service {
  ...
  constructor() {
    ...
    this.planillas = [
      new PlanillaAsistencia('Metodologias Agiles', docente38, docenteAuxiliar39, '4', 'Miercoles de 20:15 a 22:30, Sábado de 9:15 a 11',
       '2', '1', '100', '20', '25', 'admin', new Date(), lista1), 
      new PlanillaAsistencia('Materia 2', docente38, docenteAuxiliar40, '4', 'Martes de 20:15 a 22:30, Jueves de 9:15 a 11',
